...
statement		:	ioStmt	{NOTHING
			...
			;
ioStmt			:	GET_VALUE BO ID{struct value temp;temp.v.s = yylval.sVal;temp.usethis = "identifier";$3=temp;char str[20];scanf("%s",str);hash_insert_val(temp.v.s,str);} BC SEMICOL	{NOTHING
